...
import (
	...
	"stock_automation_backend_go/services/warehouse/warehouseendpoints"
...
func RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/warehouse/getWarehouseLocations", common.ResponseWrapper(warehouseendpoints.GetWarehouseLocations))
}
